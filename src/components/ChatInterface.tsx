  ...
  return (
    <>
      ...
      <div className="w-full max-w-3xl flex-1 min-h-0 flex flex-col bg-black/40 backdrop-blur-md border border-cyan-500/30 rounded-lg overflow-hidden relative shadow-[0_0_40px_rgba(6,182,212,0.1)]">
        ...
        {/* Tabs */}
        <div className="flex items-center border-b border-cyan-900/30 bg-black/40 shrink-0">
          <button
            onClick={() => onTabChange('text')}
            className={`flex-1 py-3 text-[10px] md:text-xs font-bold tracking-[0.2em] uppercase transition-all flex items-center justify-center gap-2 ${
              activeTab === 'text' 
          ...
          {activeTab === 'image' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {imageMessages.length === 0 && !isLoading && (
                  <div className="col-span-full h-full flex flex-col items-center justify-center text-purple-900/50 font-mono text-sm tracking-widest uppercase min-h-[200px]">
        ...
        {/* Input Area */}
        <div className={`p-4 bg-black/60 border-t backdrop-blur-md shrink-0 ${activeTab === 'image' ? 'border-purple-900/30' : 'border-cyan-900/30'}`}>
